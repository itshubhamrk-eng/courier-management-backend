...
@Component({
  ...
  styles: [`
    ...
    .bs__item { display:flex; align-items:center; gap:12px; padding:10px 0; border-bottom:1px solid var(--surface-border); }
    .bs__item:last-child { border-bottom:0; }
    .bs__code { display:grid; place-items:center; min-width:52px; height:30px; padding:0 8px; border-radius:8px;
      background:var(--brand-50); color:var(--brand-600); font:700 12px var(--font-sans); }
