...
@Component({
  ...
  styles: [`
    ...
    .state__icon { width:64px; height:64px; border-radius:22px; display:grid; place-items:center;
      margin-bottom:8px; background:var(--brand-50); color:var(--brand-600); box-shadow:var(--shadow-clay-sm); }
