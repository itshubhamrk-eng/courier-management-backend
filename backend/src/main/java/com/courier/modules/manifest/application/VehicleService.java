...
/**
 * Fleet management. {@code COMPANY_ADMIN}/{@code BRANCH_MANAGER} write, any authenticated
 * company user reads (the Dispatch desk needs the list to populate its picker), matching
 * every other module ahead of the authorise-on-permissions capstone.
 */
public interface VehicleService {

    Vehicle create(CreateVehicleCommand command);

    Vehicle update(UUID id, UpdateVehicleCommand command);
